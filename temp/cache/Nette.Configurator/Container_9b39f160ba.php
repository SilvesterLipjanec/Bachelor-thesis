...
class Container_9b39f160ba extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
	...
	{
		return new Container_9b39f160ba_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
...
class Container_9b39f160ba_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_9b39f160ba $container)
	{
