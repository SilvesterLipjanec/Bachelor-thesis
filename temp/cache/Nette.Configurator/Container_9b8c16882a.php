...
class Container_9b8c16882a extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
			...
			'App\Model\DatabaseRepository' => [1 => ['27_App_Model_DatabaseRepository']],
			...
			'App\Presenters\StatsPresenter' => [1 => ['application.1']],
		...
		'services' => [
			...
			'27_App_Model_DatabaseRepository' => 'App\Model\DatabaseRepository',
			'28_App_Model_UserManager' => 'App\Model\UserManager',
			'application.1' => 'App\Presenters\StatsPresenter',
	 ...
	 */
	public function createService__27_App_Model_DatabaseRepository()
	{
	...
	/**
	 * @return App\Presenters\StatsPresenter
	 */
	public function createServiceApplication__1()
	{
		$service = new App\Presenters\StatsPresenter;
	...
	{
		$service = new App\Presenters\HomepagePresenter($this->getService('27_App_Model_DatabaseRepository'));
		$service->injectPrimary($this, $this->getService('application.presenterFactory'),
			$this->getService('routing.router'), $this->getService('http.request'),
			$this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, '/var/www/html/BP/app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('/var/www/html/BP/app/../temp/cache/journal.s3db');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('/var/www/html/BP/app/../temp/cache',
	...
	{
		return new Container_9b8c16882a_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
...
class Container_9b8c16882a_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_9b8c16882a $container)
	{
